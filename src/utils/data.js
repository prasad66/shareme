...
export const searchQuery = (searchTerm) => {
  ...
  /**
   const query = `*[_type == "pin" && (title |  match "${searchTerm}*") || category match "${searchTerm}*" || about match "${searchTerm}*"]{
      image{                // get image for the given search term
          asset->{
              url
          }
      },
      _id,                  // get id for the image 
      destination,          
      postedBy->{           // get user details for the image posted by
          _id,
          userName,
          image 
      },
      save[]{               // all the user who save the image
          _key,
          postedBy->{
              _id,
              userName,
